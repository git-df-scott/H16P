...
python3 evolve.py kkl data/F4_kkl_evolve2.jsonl 60 96 0.05 --dims=3,4,9,10,11,7,8 > data/F4_kkl_evolve2.log 2>&1
python3 evolve.py file:data/kklx_seeds.jsonl data/F14_kklx_seeds_evolve2.jsonl 60 96 0.03 > data/F14_kklx_seeds_evolve2.log 2>&1
