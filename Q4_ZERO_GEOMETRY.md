# Q4 zero geometry: universal curve and an excluded cusp route
...
[Q4_STRUCTURE.md](Q4_STRUCTURE.md) establishes the positive Stieltjes representation used
...
The normalized b in this section means eta in Q4_PARAMETERIZATION.md;
it is not the original quadratic coefficient b.
...
The endpoint expansions proved in Q4_STRUCTURE.md give
