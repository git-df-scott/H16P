# Q4 structure: universal periods and a positive measure

Analytic derivation, independently reviewed, 2026-09-04. These notes use exactly the positive-area
...
Here the normalized parameter b means eta in Q4_PARAMETERIZATION.md;
it is distinct from the original quadratic coefficient also named b.
...
The following further deduction was independently checked against the
formulas here. Fix any `b∈(1,54/31)` and its inflection
...
The stronger open-neighborhood version of the cusp exclusion, and the
strict weighted-lobe criterion, are proved in [Q4_ZERO_GEOMETRY.md](Q4_ZERO_GEOMETRY.md).
