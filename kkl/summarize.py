...
summary={
    ...
    'last_accepted_common_cycle_field':{k:last[k] for k in ['c','alpha','beta','K']},
    ...
    'additional_fixed_field_test':{'c':'1001/1000','alpha':'-196/5','beta':'0',
        'evaluations':[203,204,205,206],
        'result':'Four numerical inward returns; no remote U-root bracket; conditional origin controls not run.',
        'scope':'No fixed-field or stratum-wide absence proof.'},
