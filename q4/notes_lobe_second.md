# Second-strike source notes: global weighted-lobe region
...
replayed by [q4/q4_lobe_certificate.py](q4_lobe_certificate.py).
...
[q4/data/second_lobe_certificate.json](data/second_lobe_certificate.json),
...
2. **A primitive root reaches the homoclinic endpoint.** Then
   ...
   [q4/notes_certificate_second.md](notes_certificate_second.md).
